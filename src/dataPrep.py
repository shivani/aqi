...
for stationDict in stationList:
	for my_date in range(1,30):
		if my_date != 9 :
			...
			if my_date < 10:
				d1 = dataTemplate.replace('"fromDate": "$$"', '"fromDate": "0{}-02-2018 T00:00:00Z"'.format(my_date))
				d2 = d1.replace('"toDate": "$$"', '"toDate": "0{}-02-2018 T00:00:00Z"'.format(my_date+1))
			else:
				d1 = dataTemplate.replace('"fromDate": "$$"', '"fromDate": "{}-02-2018 T00:00:00Z"'.format(my_date))
				d2 = d1.replace('"toDate": "$$"', '"toDate": "{}-02-2018 T00:00:00Z"'.format(my_date + 1))
